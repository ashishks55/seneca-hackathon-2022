    ...
    return (
        <footer style={{
            ...
            <div style={{
                ...
                <p className='has-text-centered'>Copyright © Seneca Hackathon {new Date().getFullYear()}. All rights reserved.</p>
                <p className='has-text-centered'><a href="https://1drv.ms/b/s!AjVZxwfdWPW8b7WQaRuqrmjMdyM" className='has-text-black'>Rules and Regulations</a><br /><br /></p>
            </div>
        </footer>
    );
};
