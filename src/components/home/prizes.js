            ...
            <div className="hero-body hero-body-3">
                <div className='columns'>
                    <div className='column is-12-tablet is-5-desktop is-offset-1 hero-content'>
                        ...
                        <p className="subtitle is-size-6 mg-top-1 has-text-orange">
                            <b>All challenge set winners get WINNER Micro credential & sustainable Hacktahon Tees</b>
                        </p>
                        <img src={grand_prize} alt="Grand Prize" width="100%" className='is-hidden-tablet' />
                    </div>
                    <div className='column is-5 is-hidden-touch hero-img'>
                        <img src={grand_prize} alt="Grand Prize" width="100%" />
                    </div>
                </div>
                <table border="0" cellspacing="0" cellpadding="0" className="fullWidth">
                ...
                <div className='center-text f1-div'>                    
                    ...
                    <div className='is-12-tablet is-7-desktop is-offset-1 hero-content f1-content'>
                        ...
                        <p className="title has-text-red">
                            <b>JUNE 17-19</b>
                        </p>
                        <p className="title mg-top-3">
                            <b>Exclusively for F1 Challenge set winning team</b>
                            </p>
                    </div>                    
                </div>
                <table border="0" cellspacing="0" cellpadding="0" style={{ marginTop: '3.45rem', marginBottom: '3.45rem' }} className="fullWidth">
                    <tr className='f1-car-tr'>
                        <td className='f1-car-td-white'></td>
                        <td className='f1-car-td-red'></td>
                        <td className='f1-car-td-white'></td>
                ...
                <div className='rows is-12-tablet is-12-desktop hero-content has-text-dark-green'>
                    ...
                    <div className='row prizes-trophy-40-right-div'>
                        <div className='is-hidden-desktop'><br /><br /></div>
                        <p className='center-text width-60 is-hidden-touch' style={{ backgroundImage: 'url(' + confetti + ')' }}><img className="diagonal-image" src={trophy} alt="Trophy" width="50%" /></p>
                        <p className='center-text width-60 is-hidden-desktop' style={{ backgroundImage: 'url(' + confetti + ')' }}><img className="diagonal-image" src={trophy} alt="Trophy" width="100%" /></p>
                    </div>
                    <br/>
                </div>                
            </div>
