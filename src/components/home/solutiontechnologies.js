        ...
        <section className="hero is-medium is-white">
            <div className="hero-body hero-body-2">
                <div className="columns">                    
                    ...
                    <div id="GoogleCloud" className="w3-container technology" style={{ display: 'block' }}>
                    ...
                    <div id="ESRICanada" className="w3-container technology" style={{ display: 'none' }}>
                    ...
                    <div id="SmartComputing" className="w3-container technology" style={{ display: 'none' }}>
